...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExpressionApi.Attributes();
  });
  ...
  describe('Attributes', function() {
    it('should create an instance of Attributes', function() {
      ...
      //var instance = new ExpressionApi.Attributes();
      //expect(instance).to.be.a(ExpressionApi.Attributes);
    });
    ...
    it('should have the property validReports (base name: "validReports")', function() {
      // uncomment below and update the code to test the property validReports
      //var instance = new ExpressionApi.Attributes();
      //expect(instance).to.be();
    });
